class ContactformsController < ApplicationController
  ...
  #  @contactform.destroy
  #  respond_to do |format|
  #    format.html { redirect_to contactforms_url, notice: 'Contactform was successfully destroyed.' }
  ...
  private
    ...
    def contactform_params
      params.require(:contactform).permit(:contact_type, :contact_name, :contact_email, :contact_phone, :contact_msg)
    end
end